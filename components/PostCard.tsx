...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
  ...
  return (
    <article className="p-4 border-b border-slate-700/50 hover:bg-slate-800/40 transition-colors duration-200">
            <div className="flex space-x-4">
                ...
                <div className="flex-1">
                    ...
                    {post.imageUrl && (
                        <div className="mt-3 rounded-2xl overflow-hidden w-full border border-slate-700/50 shadow-lg shadow-black/20">
                    ...
                    <div className="flex justify-between items-center mt-4 text-gray-400 max-w-sm">
                        ...
                        <button onClick={handleLike} className="flex items-center space-x-2 hover:text-pink-500 transition-colors group">
                           <div className="p-2 group-hover:bg-pink-500/10 rounded-full">
                            ...
                            <span className={`text-sm ${isLiked ? 'text-pink-500' : ''}`}>{likes.toLocaleString()}</span>
                        </button>
